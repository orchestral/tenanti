...
[![tests](https://github.com/orchestral/tenanti/workflows/tests/badge.svg?branch=5.x)](https://github.com/orchestral/tenanti/actions?query=workflow%3Atests+branch%3A5.x)
